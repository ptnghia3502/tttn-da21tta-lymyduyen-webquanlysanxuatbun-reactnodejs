...
const nguyenVatLieuRoutes = require('./routes/nguyenVatLieuRoutes/nguyenVatLieuRoutes');
const userRoutes = require('./routes/nguoiDungRoutes/userRoutes');
const roleRoutes = require('./routes/roleRoutes/roleRoutes');
const thanhphamRoutes = require('./routes/thanhphamRoutes/thanhphamRoutes');
